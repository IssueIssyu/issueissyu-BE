...
public enum MapPinCategory {
    ...
    // 쿼리는 소문자, DB는 대문자, 성공코드
    ISSUE("issue", "ISSUE", MapSuccessCode.MAP_200_2),
    COMMUNICATION("communication", "COMMUNICATION", MapSuccessCode.MAP_200_3),
    STORE("store", "STORE", MapSuccessCode.MAP_200_4),
    FESTIVAL("festival", "FESTIVAL", MapSuccessCode.MAP_200_5);
