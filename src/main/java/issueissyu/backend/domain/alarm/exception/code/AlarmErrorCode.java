...
public enum AlarmErrorCode implements BaseErrorCode {
    ...
    ALARM_TOKEN_400(HttpStatus.BAD_REQUEST, "ALARM_TOKEN_400", "유효하지 않은 토큰을 입력하였습니다."),
    ...
    HOT_ALARM_404(HttpStatus.NOT_FOUND, "HOT_ALARM_404", "존재하지 않는 인기글 알람입니다."),
    HOT_ALARM_403(HttpStatus.FORBIDDEN, "HOT_ALARM_403", "해당 사용자는 푸시 알림 수신을 제한해두었습니다."),
    HOT_ALARM_400(HttpStatus.BAD_REQUEST, "HOT_ALARM_400", "푸시 알림 전송에 실패했습니다."),
