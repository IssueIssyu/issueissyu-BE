...
public class BillingQueryServiceImpl implements BillingQueryService {
    ...
    public List<ProductRes> getProducts() {
        ...
        List<Emoji> emojiList = emojiRepository.findAllByOrderByEmojiIdAsc();
        return BillingConverter.toProductResList(emojiList);
    }

    @Override
    public MyPurchasesRes getMyPurchases(String uid) {
        return BillingConverter.toMyPurchasesRes(userEmojiRepository.findOwnedEmojiIdsByUid(uid));
    }
}
