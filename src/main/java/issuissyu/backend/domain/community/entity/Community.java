package issuissyu.backend.domain.community.entity;

import issuissyu.backend.domain.community.enums.CommunityPostStatus;
import issuissyu.backend.domain.community.enums.CommunityType;
...
public class Community extends BaseEntity {
    ...
    @Column(name = "view_coount", nullable = false)
